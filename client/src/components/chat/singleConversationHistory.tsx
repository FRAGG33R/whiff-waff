...
export default function SingleConversationHistory(
  ...
  return (
    <motion.div 
		...
		className={`h-12 md:h-[5rem] xl:h-[6.4rem] w-full cursor-pointer ${props.selected === true ? "bg-[#6C7FA7]/[12%]" : "bg-transparent"}  hover:bg-HokiCl/[12%] rounded-[12px] md:rounded-[20px] flex items-center justify-center flex-row md:space-x-2 2xl:space-x-4 px-2`}>
      <div className="h-8 w-8 lg:w-14 lg:h-14 2xl:w-16 2xl:h-16 3xl:w-20 3xl:h-20 bg-HokiCl rounded-[6px] md:rounded-[12px] 2xl:rounded-[20px] ">
