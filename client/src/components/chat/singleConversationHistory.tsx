...
export default function SingleConversationHistory(
  ...
  return (
    <motion.div 
      ...
      <div className="h-10 w-10 lg:w-14 lg:h-14 2xl:w-16 2xl:h-16 3xl:w-20 3xl:h-20 bg-HokiCl rounded-[12px] 2xl:rounded-[20px] ">
		<img alt="" className="w-full h-full rounded-[12px] 2xl:rounded-[20px]" src={props.avatar} />
	  </div>
