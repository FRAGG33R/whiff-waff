  ...
  return (
    <div className="w-full 2xl:h-full flex  flex-col gap-4 md:gap-6  ">
      <div className=" w-full 2xl:h-[120px] flex  flex-col items-center justify-center">
        <div className=" w-full 2xl:h-[100px] flex items-center justify-center font-teko text-[3.5rem] text-[#FFFFFF] " >
          Option
        </div>
        <div className=" w-[80%] 2xl:h-[5px] xl:h-[8px] lg:h-[8px] md:h-[6px] h-[5px] flex items-center bg-GreenishYellow justify-center font-teko text-[3rem] " />
      </div>
      <div className=" w-full 2xl:h-[950px] xl:h-[800px] lg:h-[800px] md:h-[800px] h-[800px] flex  justify-center ">
        <div className="w-full 2xl:h-full flex  flex-col items-center justify-center gap-6 ">
          ...
          <div className="w-full 2xl:h-[110px] flex items-center justify-start  font-teko text-[#FFFFFF] text-[3rem] ">
            Mode
          </div>
          ...
          <button className={`w-[45%] xl:h-[100px] lg:h-[100px] md:h-[100px] 2xl:h-[110px] h-[80px] flex flex-row items-center justify-center rounded-3xl bg-[#606060] bg-opacity-10 gap-2  
          ...
          <div className="w-full 2xl:h-[110px] flex items-center justify-center ">
