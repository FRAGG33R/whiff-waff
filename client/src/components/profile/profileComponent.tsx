export default function Profile() {
  return (
    <div className="w-full md:w-[98%] h-full md:h-[95%] flex items-center justify-start flex-row bg-black/60 text-white">
      <div className="h-full w-[13%] lg:w-[5%] border-2 border-white"></div>
      <div className="h-full w-full border-2 border-white">
        <div className="h-[7%] w-full border-2 border-white"></div>
