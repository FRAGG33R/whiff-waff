...
export default function RankComponent()
{
	...
	return (
		<div className="w-full h-full flex flex-col bg-[#606060]/[12%] rounded-[12px] md:rounded-[20px]">
			<div className="w-full h-[15%] flex items-center justify-start space-x-2 py-6 md:py-0  px-2 md:px-4 md:pt-3">
			...
			<div className="w-full h-[85%] flex items-center justify-center py-4">
				<Image src={`/${user.stat.rank}.svg`} alt="grandmaster icon" width={0} height={0} className='w-[240px] lg:w-[280px] 2xl:w-[320px] pb-14'/>
			</div>
		</div>
	)
}