    ...
    <div key={props.index} className="w-[95%] h-16 md:h-24 flex flex-row items-start justify-center rounded-[12px] md:rounded-[20px] bg-[#0F0F0F]/[32%]">
      ...
      <div className="w-full min-h-1 flex flex-col items-start justify-start md:space-y-3  text-Mercury uppercase -ml-6 md:pt-4">
        <div className="w-full min-h-1 flex flex-col">
          <div className="text-xl md:text-[1.7rem] font-medium max-h-6 flex items-center tracking-wide font-teko">{props.title}</div>
          <div className="text-[0.7rem] md:text-[1.1rem] font-thin max-h-5 tracking-wider pr-[0.09rem] font-teko">{props.description}</div>
        </div>
