  ...
  return (
    <div className="w-[98%] h-[96%] md:h-[95%] flex items-center justify-start gap-2 md:gap-10 flex-row overflow-y-hidden">
      ...
      <div className="h-[45px] md:h-[50px] lg:h-[60px] xl:h-[70px] w-full ">
        ...
        <div className="w-full xl:h-[91%] md:h-[93%] lg:h-[91.5%] h-[91.5%] overflow-y-scroll xl:overflow-y-auto space-y-2 xl:space-y-10">
          <div className="w-full h-[1450px] sm:h-[1400px] md:h-[1340px] lg:h-[1800px] xl:h-[1100px] flex flex-col xl:flex-row gap-2 xl:gap-10 ">
