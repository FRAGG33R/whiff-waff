  ...
  return (
    <div className="w-[96%]  md:w-[95%] h-[96%]   flex items-center  justify-start flex-col gap-2 md:gap-5 ">
      ...
      <div className="w-[96%] h-[20%] md:h-[12%] sm:h-[12%] flex flex-col items-center ">
        ...
        <div className="w-full h-[40%] md:h-[38%] sm:h[40%] flex justify-center  items-center text-[0.7rem] text-center font-poppins font-thin">
          Scan this QR code with your Google Authenticator App
        </div>
      </div>
      <div className="w-[96%] h-[35%] flex flex-col items-center  gap-2 ms:gap-5 ">
        <div className="w-full h-[70%]  ">
          <Image src={CodeQr} alt="CodeQr" className="w-full h-full  flex " />
        </div>
        <div className="w-full h-[30%]  font-poppins md:text-xl  sm:text-[0.7rem] text-center ">
          Enter code from your two-factor authentication app
        </div>
      </div>
      <div className="w-[96%] h-[10%] flex flex-col items-center justify-center ">
        <div>
          <UserInput
            placeholder="*****"
            type="password"
