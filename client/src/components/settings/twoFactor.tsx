  ...
  return (
    <div className="w-full h-full flex flex-col gap-4 md:gap-6  ">
      <div className="w-full h-[6%]  md:h-[10%] flex flex-row items-center space-x-2 md:space-x-4 px-3 md:px-10 md:py-2  ">
        ...
        />
        <div className="font-semibold font-teko text-md md:text-[1.9rem]  tracking-wide text-Mercury md:pt-2">
          TWO-FACTOR AUTHENTICATION
        </div>
      </div>
      <div className="w-full h-[95%] md:h-[84%] flex flex-col gap-4 ">
        <div className="w-full h-[15%] flex flex-col ">
          <div className="w-full h-[40%] flex justify-center items-center font-poppins text-[0.9rem]  sm:text-xl md:text-2xl lg:text-xl xl:text-2xl 2xl:text-2xl 3xl:text-4xl text-center font-bold">
            Set up two-factor authentication
          </div>
          <div className="w-full h-[50%]  flex justify-center  items-start text-[0.5rem] sm:text-[0.7rem] md:text-sm lg:text-[0.7rem] xl:text-sm text-center font-poppins  font-thin">
        ...
        <div className="w-full h-[80%] flex flex-col items-center justify-start gap-3">
          ...
          <div className="w-full h-[60%] flex flex-col justify-start items-center gap-2 md:gap-4">
            <div className="  w-[12rem] sm:w-[13rem]   md:w-[15rem] lg:w-[18rem] xl:w-[22rem] h-[20%]  flex font-poppins text-[0.7rem]   md:text-[0.8rem] sm:text-[0.7rem] lg:text-[1rem] xl:text-[1rem]  text-center">
