...
const IntraButton: React.FC<PrimaryButtonProps> = ({text, onClick }) => {
  return (
    <motion.button 
      ...
      whileTap={{ scale: 0.9 }}
    	className='flex items-center justify-center flex-row space-x-2 bg-Ceramic text-NightBlack md:text-2xl text-xl font-teko  w-40 md:w-52 lg:w-56 h-10 rounded-md' onClick={onClick}>
