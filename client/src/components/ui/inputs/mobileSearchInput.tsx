  ...
  return (
    <div className="relative w-full h-full text-gray-600 bg-transparent">
      ...
      {searchValue !== null && loaded === true && (
        <div className="w-full absolute min-h-1 max-h-72 overflow-y-auto scrollbar scrollbar-track-rounded-full scrollbar-thumb-ViolentViolet  scrollbar-track-transparent z-50 bg-HokiCl rounded-[12px] md:rounded-[20px] mt-1 p-1">
