      ...
      <input
        ...
        ${
          width === "sm"
            ...
            : width === "sml"
            ? "w-[6rem] sm:w-[10.5rem] smd:w-[8rem]  md:w-[10rem] lg:w-[14.5rem] xl:w-[14rem] 2xl:w-[15.5rem] 3xl:w-[25.5rem]  h-7  md:h-10 sm:h-10 lg:h-14  xl:h-14 3xl:h-16  text-[0.7rem] sm:text-lg md:text-md lg:text-xl xl:text-2xl 2xl:text-2xl 3xl:text-2xl"
            : width === "2xl"
            ? "w-[13rem]  sm:w-[22rem]  md:w-[22rem] lg:w-[31.3rem] xl:w-[31rem] 2xl:w-[35rem] 3xl:w-[54rem] h-9 md:h-10 sm:h-10 lg:h-14 xl:h-14 3xl:h-16 text-sm sm:text-lg md:text-md lg:text-xl xl:text-2xl 2xl:text-2xl 3xl:text-2xl"
            : width === "code"
