  ...
  return (
    <div className="relative w-full">
      ...
      <input
        ...
        onBlur={handleBlur}
        value={value}
        className={`bg-transparent rounded-full font-poppins  sm:text-[0.9rem]  placeholder-PastelGrey  placeholder-left pl-4 sm:pl-6 md:pl-6 border-2 border-Mercury text-bottom
         focus:outline-none
        ...
        ${
          width === "sm"
            ...
            : width === "sml"
            ? "w-[6rem] sm:w-[10.5rem] smd:w-[8rem]  md:w-[10rem] lg:w-[11.5rem] xl:w-[14rem] 2xl:w-[15.5rem] 3xl:w-[22.3rem]  h-9  md:h-10 sm:h-10 lg:h-12 3xl:h-14  text-sm md:text-md"
            : width === "2xl"
            ? "w-[13rem]  sm:w-[22rem]  md:w-[22rem] lg:w-[26rem] xl:w-[31rem] 2xl:w-[35rem] 3xl:w-[48rem] h-9 md:h-10 sm:h-10 lg:h-12 3xl:h-14 text-sm md:text-md"
            : width === "code"
            ? "w-[12rem]  sm:w-[13rem]  md:w-[15rem] lg:w-[18rem] xl:w-[18rem]  md:h-12 h-10 3xl:h-14 text-xl sm:text-xl md:text-2xl lg:text-3xl xl:text-3xl 2xl:text-3xl 3xl:text-6xl text-bottom "
            : ""
        }`}
      ></input>
    </div>
