...
const LevelBar: React.FC<LevelProps> = ({ level, progress }) => {
  return (
    <div className="w-full h-full">
      <div className="md:mb-2 w-full md:w-8/12 flex items-center justify-between text-HokiCl gap-4">
      ...
      <div className="w-full md:w-8/12 h-2 md:h-4 bg-HokiCl rounded-full">
        <div
