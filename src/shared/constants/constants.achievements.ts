export const ACHIEVEMENT_CATEGORY_1 = {name: "WHIF-WHAF ROOKIE", description: "win the first match"};
export const ACHIEVEMENT_CATEGORY_2 = {name: "WHIF-WHAF LEGEND", description: "win 100 natch"};
